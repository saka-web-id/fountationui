...
interface CognitiveSettingItem {
  id: string;
  name: string;
  icon: string;
  route: { name: string };
...
const settings = ref<CognitiveSettingItem[]>([
  {
    id: 'ai-provider',
    name: t('cognitive.aiProvider'),
    icon: 'bi-robot',
...
const columnHelper = createColumnHelper<CognitiveSettingItem>();
const columns = [
...
const handleNavigation = (item: CognitiveSettingItem) => {
  ...
  <section class="pt-2 pb-2">
    <div class="container">
      <ol class="breadcrumb ms-4">
        ...
        <li class="breadcrumb-item active"><span class="active">{{ t('cognitive.title') }}</span></li>
      </ol>
