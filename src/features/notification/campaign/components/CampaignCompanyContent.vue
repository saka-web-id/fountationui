...
import { useCampaignCompanyTable } from '../hooks/tables/useCampaignCompanyTable';
  ...
  <section class="pt-2 pb-2">
    <div class="container">
      <ol class="breadcrumb ms-2 me-2">
        ...
        <li class="breadcrumb-item"><router-link to="/notification/campaign"><span>{{ t('campaign.listTitle') }}</span></router-link></li>
      ...
      <div class="card mb-3 bg-gradient-dark">
        <div class="card-body ms-0 ps-0 me-0 pe-0 mt-0 pt-0 pb-0">
          <div class="row d-flex justify-content-between align-items-center me-2 mt-2 mb-2">
            <div class="col-auto">
              <h4 class="ps-0 ps-md-3 fs-5 fs-md-3 ms-2">{{ t('campaign.listTitle') }}</h4>
            </div>
