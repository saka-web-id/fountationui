...
import { useWhatappsSettingTable } from '../hooks/tables/useWhatappsSettingTable'
...
const {
  ...
  fetchData,
  t
} = useWhatappsSettingTable(companyIdParam);
        ...
        <div class="card-body ms-0 ps-0 me-0 pe-0 mt-0 pt-0 pb-0">
          <div class="row d-flex justify-content-between align-items-center me-2 mt-2 mb-2">
            ...
            <div class="col-auto d-flex gap-2 ms-2">
              ...
              />
              <button @click="router.push({ name: 'notificationdetailaddwhatapps', params: { companyIdParam: companyIdParam } })" class="btn btn-outline-primary text-nowrap" type="button">{{ t('button.add') }}</button>
            </div>
          </div>
