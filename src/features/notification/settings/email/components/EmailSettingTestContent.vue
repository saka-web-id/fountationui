...
} from "~/features/notification/settings/email/hooks/forms/useEmailSettingTestForm.ts";
...
onMounted(async () => {
  await getNotificationProvider(`/v0/notification/provider/list/companyId/${auth.user?.company.companyId}/userId/${auth.user?.id}/valueCompanyId/${companyIdParam}/notificationType/EMAIL`);
});
  ...
  <section class="pt-2 pb-2">
    <div class="container">
      <ol class="breadcrumb ms-4">
        ...
        <li class="breadcrumb-item active">{{ t('button.edit') }}</li>
      </ol>

      <div class="card mb-3 bg-gradient-dark">
        <div class="card-body p-4">
          <div id="idform">
            <h4 class="mb-4">{{ t('button.edit') }}</h4>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <div class="input-group mb-2">
                  ...
                  <input v-model="notificationSource" type="text" class="form-control" placeholder="Sender Email" />
                </div>
              ...
              <div class="col-md-6">
                <div class="input-group mb-2">
                  <span class="input-group-text w-25">Source</span>
                  <input v-model="notificationDestination" type="text" class="form-control" placeholder="Destination Email" />
                </div>
              ...
              <div class="col-md-6">
                <div class="input-group mb-2">
                  ...
                  <input v-model="notificationSubject" type="text" class="form-control" />
                </div>
              </div>
