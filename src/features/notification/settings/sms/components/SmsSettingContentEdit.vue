...
} from "../hooks/forms/useSmsSettingForm";
import { useSmsSettingContentEditTable } from '../hooks/tables/useSmsSettingContentEditTable';
...
// Form Manager from useSmsSettingForm
const {
...
const { table, globalFilter } = useSmsSettingContentEditTable(
  configs,
...
const executeSubmit = async (finalValues: any) => {
  ...
  try {
    ...
    // router.push({ name: 'notificationlistsms' })
