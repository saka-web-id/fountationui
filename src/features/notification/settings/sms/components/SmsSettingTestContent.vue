...
} from "~/features/notification/settings/sms/hooks/forms/useSmsSettingTestForm.ts";
...
onMounted(async () => {
  await getNotificationProvider(`/v0/notification/provider/list/companyId/${auth.user?.company.companyId}/userId/${auth.user?.id}/valueCompanyId/${companyIdParam}/notificationType/SMS`);
});
    ...
    <div class="container">
      <ol class="breadcrumb ms-4">
        ...
        <li class="breadcrumb-item">
          <router-link :to="{ name: 'notificationlistsms', params: { companyIdParam: companyIdParam } }">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <div class="input-group mb-2">
                  ...
                  <input v-model="notificationSource" type="text" class="form-control" placeholder="Sender ID / Number" />
                </div>
              ...
              <!-- Subject is usually not used in SMS, but kept for payload consistency -->
              <div class="col-md-6">
                <div class="input-group mb-2">
