...
import { useNotificationSettingTable } from './hooks/tables/useNotificationSettingTable';
  ...
  <section class="pt-2 pb-2">
    <div class="container">
      <ol class="breadcrumb ms-4">
        ...
        <li class="breadcrumb-item active"><span class="active">{{ t('textLabel.notificationSetting', 2) }}</span></li>
      </ol>
          ...
          <div class="row d-flex justify-content-between align-items-center mb-4">
            <div class="col-auto">
              <h3 class="fw-bold text-white mb-0">
                {{ t('textLabel.notificationSetting', 2) }}
              </h3>
