...
import { useGlobalSettingTable } from '../hooks/tables/useGlobalSettingTable';
  ...
  <section class="pt-2 pb-2">
    <div class="container">
      <ol class="breadcrumb ms-4">
        ...
        <li class="breadcrumb-item active"><span class="active">{{ t('textLabel.setting', 2) }}</span></li>
      </ol>
