...
import { useRegistryMenuTable } from '~/features/registry/submenu/hooks/tables/useRegistryMenuTable';
  ...
  <section class="pt-2 pb-2">
    <div class="container">
      <ol class="breadcrumb ms-4">
        ...
        <li class="breadcrumb-item active"><span class="active">{{ t('textLabel.registry', 2) }}</span></li>
      </ol>
